...
```bash
python3 ex14.py 100 1.0 1.0 100.0
./matrix_display/display
python3 ex14.py 70 1.0 1.0 100.0
./matrix_display/display
python3 ex14.py 40 1.0 1.0 100.0
./matrix_display/display
```
...
```bash
python3 ex14.py 100 3.0 1 100.0
./matrix_display/display
python3 ex14.py 100 1.7778 1 100.0   
./matrix_display/display
python3 ex14.py 100 0.5 1 100.0
./matrix_display/display
```
...
```bash
python3 ex14.py 100 1.0 1.0 10.0
./matrix_display/display
python3 ex14.py 100 1.0 5.0 50.0
./matrix_display/display
```
